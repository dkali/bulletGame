...
/*		
	...
	count = (Input.GetMouseButtonDown(0) ? 1 : 0);
#endif
*/
	if ( count == 0 )
		ResetJoystick();
...
/*#if UNITY_STANDALONE_WIN
			if ( Input.GetMouseButtonDown(0) ) {
				touch.position = Vector2(Input.mousePosition.x, Input.mousePosition.y);
				touch.fingerId = 1;
				touch.tapCount = 1;
	...
	gvnbfr.transform.position.x = position.x;	 
	gvnbfr.transform.position.y = position.y;
}